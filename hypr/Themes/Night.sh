...
sed -i 's/"workbench.colorTheme": "[^"]*"/"workbench.colorTheme": "Mayukai Alucard"/g' ~/.config/Code/User/settings.json
sed -i 's/"workbench.iconTheme": "[^"]*"/"workbench.iconTheme": "helium-icon-theme"/g' ~/.config/Code/User/settings.json
#------------------------------------------Waybar------------------------------------------------------------------#
